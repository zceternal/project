	...
	<div class="panel panel-default">
		...
		<div class="site_change contact">
			<form class="form-horizontal" role="form" id="contactAddForm"
				action="../contact/add" method="post" data-ajax="true"
				data-ajax-success="contactAddSuccessForShare">
					...
					<div class="col-sm-10 favorite">
						<div>
							<c:forEach items="${dictLxr }" var="item" varStatus="status">
								<label class="checkbox-inline "> <input type="radio"
									name="role" value="${item.id }"  ${status.index==0?'checked':'' }>${item.name }
								</label>
							</c:forEach>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 favorite" style="padding-left: 0px;">
						<div>
							<textarea class="form-control" name="hobby" style="width: 570px"
								rows=4></textarea>
						</div>
					</div>
				</div>
