...
<div class="main_content dialog">
	<div class="panel panel-default">
		<form class="form-horizontal old_block" role="form"
			id="myformSaveRemind" action="../customer/saveRemind" method="post"
			data-ajax="true" data-ajax-success="onCustomerSuccessSaveRemind">
			...
			<div class="form-group">
				...
				<div class="inline relative">
					<input type="text" class="form-control input150 validate[required]"
						...
						value="${remindTime }" input-type="date"> <span
			...
			<div class="form-group">
				...
				<div class="inline">
					<textarea class="form-control validate[maxSize[5000]]" id="remark"
						name="remark" placeholder="请输入提醒内容" style="width: 320px"
						data-prompt-position="inline" rows=4>${model.remark }</textarea>
				</div>
			</div>
...
<script type="text/javascript">
	$("#myformSaveRemind").validationEngine({
