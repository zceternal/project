...
<div class="col-xs-12 col-sm-12 div_bordered">
	<div class="panel panel-default">
		<div class="panel-heading">
			<form method="post" action="mymessage" class="form-inline" id="myform"
				data-ajax="true" data-ajax-mode="replace"
				data-ajax-update="#mymessage_update_result">
		...
		<div id="mymessage_update_result">

			<jsp:include page="_mymessage_list.jsp" />
